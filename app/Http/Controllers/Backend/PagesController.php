...
class PagesController extends Controller
{
    ...
    public function create(Page $page)
    {
        ...
        return view('backend.pages.form', compact('page', 'templates', 'orderPage'));
    }
    ...
    {
        $page = $this->pages->create($request->only('title', 'url' , 'name' , 'content', 'template', 'hidden'));
    ...
    public function destroy($id)
    {
        ...
        $page->delete();
        return redirect(route('b \ackend.pages.index'))->with('status' , 'Page has been deleted');
    }
